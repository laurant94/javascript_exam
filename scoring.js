...
$(document).ready(function () {
  ...
  function get_achievement() {
    ...
    let averageIndicate = parseInt($("#average_indicate").text());
    // console.log(averageIndicate)
    // Si "averageIndicate" est égal ou supérieur à 80, retournez "A".
    if (averageIndicate >= 80) {
      return "A";
    }
    else if(averageIndicate>=60) return "B";
    else if(averageIndicate>=40) return "C";
    else return "D";
  ...
  function get_pass_or_failure() {
    ...
    let lost = subject_points.find(i=>i<60)
    if(lost===null || lost===undefined) judge= "Passer";
    else judge = "Rejeté"
